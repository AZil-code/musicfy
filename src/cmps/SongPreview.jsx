export function SongPreview({ idx, song, onSelect, onRemove, isCurrent, isPlaying }) {
    ...
    const albumName =
        typeof song.album === 'string' && song.album.trim().length
            ? song.album.trim()
            : 'Unknown album'

    const fallbackArtwork = 'https://images.unsplash.com/photo-1511379938547-c1f69419868d?auto=format&fit=crop&w=200&q=60'
    const artworkUrl =
    ...
    return (
        ...
        >
            ...
            <button
                className="song-preview-more-btn"
                type="button"
